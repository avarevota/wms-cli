...
`npx` is useful for one-off commands or CI; use the global install for daily use.
...
See [DEVELOPMENT.md](DEVELOPMENT.md) for setup, scripts, project layout, and guidance on extending the CLI.
